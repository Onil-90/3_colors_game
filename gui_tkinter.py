...
def app():
    ...
    # New game button
    new_game = Button (root, bg='black', fg='white', text="New Game", activebackground = 'white', command=refresh) 
    new_game.grid(row=0,column=3,  pady = v_margin, padx = h_margin)
    # Exit button
    exit = Button (root, bg='black', fg='white', text="Exit", activebackground = 'red', command = close) 
